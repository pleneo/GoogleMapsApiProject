((g) => {
  ...
  key: "AIzaSyAOD9cmyNnmuend4WemM8RK7lnklOnDi9Q", //change this by your google maps API key, this one is restricted.
  v: "weekly",
...
function adicionarLinhaTabela(nome, lat, lng, ponto) {
  ...
  botaoExcluir.addEventListener("click", async () => {
    ...
    //consult the marker name, lng and lat on the api server and delete it, if exists.
    const response = await fetch(
      `/api/markers?name=${nome}&lat=${lat}&lng=${lng}`,
      {
        method: "DELETE",
      }
    );
